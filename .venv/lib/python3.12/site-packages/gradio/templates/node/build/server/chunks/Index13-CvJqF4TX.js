...
import { B as Block, S as Static, f as BlockLabel, N as Code$2, h as Empty, j as IconButton, w as Copy$1, D as Download$1, i as IconButtonWrapper } from './2-Cvaib1R4.js';
...
const lang_map = {
  python: () => import('./index28-v3D-BLJp.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index29-CYUPU3lG.js'),
      import('./frontmatter-Ch8s3Ejn.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index33-DeXnb3FI.js').then((m) => m.json()),
  html: () => import('./index30-DfTEJRM_.js').then((m) => m.html()),
  css: () => import('./index31-CuQLzNfi.js').then((m) => m.css()),
  javascript: () => import('./index32-xZsRdUDd.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index32-xZsRdUDd.js').then(
...
//# sourceMappingURL=Index13-CvJqF4TX.js.map
